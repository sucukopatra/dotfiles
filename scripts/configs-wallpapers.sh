...
find ~/dotfiles/assets/config/.config/wofi/ -type f -name "*.css" -exec sed -i "s|/home/USER|/home/$(whoami)|g" {} +
sed -i "s|USER|$(whoami)|g" ~/dotfiles/assets/.conf/autologin.conf
sed -i "s|/home/USER|/home/$(whoami)|g" ~/dotfiles/assets/config/.config/fastanime/config.ini
